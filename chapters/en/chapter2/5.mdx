# End to end AI Application with Inference Endpoints
...
- A running Inference Endpoint (created in the previous unit)
- Your endpoint URL and an access token
...
When you're comfortable with your app, continue to the summary and quiz.
